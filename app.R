...
inputPanel(
  numericInput("effsize",label = h5("Effect size (as multiple of SD)"),step=0.003,min=0.01, value = 1.0)
    ...
    helpText("Please cite this page if you find it useful,          version 1.4 Longstaff,C. and Colquhoun D, https://davidcolquhoun.shinyapps.io/3-calcs-final/ Last accessed", Sys.Date())
  ),
...
helpText("From ver 1.3 onwards, the values of power that are printed out are calculated for P = 0.05 and the specified effect size (expressed as a multiple of the standard deviation of the observations).  In earlier versions they were calculated using the  observed P value).\n Ver 1.4 has updated help notes."
),
